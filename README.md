...
This repository also includes the data used in the publication for benchmarking protein modeling tools, performing docking analysis with TCRdock, and conducting consensus analysis.
