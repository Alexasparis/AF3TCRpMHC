...
parser.add_argument('-pae', nargs=1, type= str, required=True, help ='Input pickle file.')
...
def main():
    ...
    avgif_pae = retrieve_IFPAEinter(structure, data, remain_contact_lst, args.dist)
    ## calculate pmiDockQ
